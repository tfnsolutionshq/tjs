...
class PlatformSettings
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            'pitch' => config('tjs.pitch'),
            'tagline' => config('tjs.tagline'),
            'description' => config('tjs.description'),
    ...
    public static function current(): array
    {
        ...
        return [
            ...
            'landing_headline' => $stored['landing_headline'] ?? $defaults['landing_headline'],
            'pitch' => $stored['pitch'] ?? $defaults['pitch'],
            'tagline' => $stored['tagline'] ?? $defaults['tagline'],
            'description' => $stored['description'] ?? $defaults['description'],
            'landing_about_heading' => $stored['landing_about_heading'] ?? $defaults['landing_about_heading'],
            'landing_footer_publishing' => $stored['landing_footer_publishing'] ?? $defaults['landing_footer_publishing'],
    ...
    public static function applyToConfig(): void
    {
        ...
        config([
            ...
            'tjs.landing_headline' => $current['landing_headline'],
            'tjs.pitch' => $current['pitch'],
            'tjs.tagline' => $current['tagline'],
            'tjs.description' => $current['description'],
            'tjs.landing_about_heading' => $current['landing_about_heading'],
            'tjs.landing_footer_publishing' => $current['landing_footer_publishing'],
